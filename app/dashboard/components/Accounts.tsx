...
const platforms = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Request akses "Share on LinkedIn" & "Sign In with LinkedIn"',
              ...
              {filteredAccounts.map(acc => {
                ...
                return (
                  <div key={acc.id} style={{
                    ...
                    {/* SVG Icon badge — sama persis dengan Post.tsx */}
                    <div style={{
                      width:'42px', height:'42px', borderRadius:'12px',
                      background: plat?.selectedBg || '#333',
                      display:'flex', alignItems:'center', justifyContent:'center',
                      flexShrink:0, color:'white',
                      boxShadow:`0 0 10px ${plat?.color || '#333'}55`,
            ...
            {platforms.map(p => (
              <div key={p.id}>
                <div style={{
                  ...
                  {/* SVG Icon — sama dengan daftar akun */}
                  <div style={{
                ...
                {showGuide === p.id && (
                  <div style={{
                    ...
                    <div style={{ marginTop:'12px', padding:'10px 14px', borderRadius:'8px', background:'rgba(255,255,255,0.04)', border:'1px solid rgba(255,255,255,0.08)' }}>
                      <div style={{ fontSize:'12px', color:'rgba(255,255,255,0.5)', marginBottom:'4px' }}>Field yang dibutuhkan:</div>
                  ...
                  <div style={{
                    ...
                    <div style={{ display:'flex', alignItems:'center', gap:'10px', marginBottom:'14px' }}>
                      <div style={{
                        ...
                        background: p.selectedBg, display:'flex', alignItems:'center',
